import { Http, RequestOptionsArgs, RequestOptions, Request, Response } from '@angular/http';
...
export declare class AuthHttp {
    ...
    private _http;
    private _options;
    constructor(config: AuthConfig, _tokenService: TokenService, _http: Http, _options: RequestOptions);
